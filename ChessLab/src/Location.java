...
public class Location implements Comparable
{
     ...
     * @return the adjacent location in the direction that is closest to direction
     */
     ...
     * @return true if other is a Location with the same row and column as this location;
     *         false otherwise
     */
     ...
     * @param other the other location to test
     * @return a negative integer if this location is less than other,
     *         zero if the two locations are equal, or a positive integer
     *         if this location is greater than other
     */
